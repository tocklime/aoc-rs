...
#[must_use] pub fn p1(input: &str) -> isize {
    (0..5)
        .permutations(5)
...
#[must_use] pub fn p2(input: &str) -> isize {
    (5..10)
        .permutations(5)
        .map(|x| run_comp_loop(input, &x))
        .max()
...
pub fn p2_tests() {
    ...
    assert_eq!(run_comp_loop(e0, &[9, 8, 7, 6, 5]), 139_629_729);
    assert_eq!(p2(e0), 139_629_729);
    ...
    assert_eq!(run_comp_loop(e1, &[9, 7, 8, 5, 6]), 18216);
