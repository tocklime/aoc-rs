...
impl Game {
    #[inline]
    fn draw_cards(&mut self) -> Option<(Card, Card)> {
    ...
    #[inline]
    fn replace_cards(&mut self, winner: Player, cards: (Card, Card)) {
        match winner {
            0 => {
    ...
    fn score_player(&self, player: Player) -> u32 {
    ...
    fn recursive_game(&mut self, game_count: &mut i32, check_every: usize) -> Player {
