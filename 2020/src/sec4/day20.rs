...
impl<'a> Placement<'a> {
    ...
    pub fn edge_matches(&self, edge: u8, connections: &HashMap<usize, Vec<Self>>) -> Vec<Self> {
    ...
    pub fn get_edge_pattern(&self, edge: u8) -> usize {
...
impl Tile {
    pub fn get_edge_id(&self, n: u8, flip: bool) -> usize {
    ...
    pub fn get_all_possible_ids<'a>(&'a self) -> impl Iterator<Item = (usize, Placement<'a>)> + 'a {
...
pub fn flatten(arr: &Array2<Option<Placement>>) -> Array2<bool> {
...
pub fn print_simple_grid(arr: &Array2<bool>) {
...
pub fn print_grid(arr: &Array2<Option<Placement>>) {
    let wid = 10;
